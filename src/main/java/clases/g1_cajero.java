 ...
 * @author josrm
 */
public class g1_cajero extends g1_persona {
    private String codEmpleado;
    g1_cajero cajero;

    public g1_cajero(String codEmpleado, String cedula, String nombre, int id, String clave, int tipo) {
        super(cedula, nombre, id, clave, tipo);
        this.codEmpleado = codEmpleado;
    }

    public g1_cajero(String codEmpleado, String cedula, String nombre) {
        super(cedula, nombre);
        this.codEmpleado = codEmpleado;
    }

    public g1_cajero(String codEmpleado) {
        this.codEmpleado = codEmpleado;
    }
    ...
    public String toString() {
        String salida = "Datos del cajero \n"
                + "Id usuario: "+ getId() +"\n"
                + "Nombre: "+getNombre() + "\n"
                + "Cedula: "+ getCedula() +"\n"
    ...
    public void menu(ArrayList sistemaCC,
        ...
        this.cajero = (g1_cajero)u;
        String menu[] = {
            "Menu principal de cajero",
    ...
    private void modificarPerfil(){
        int sel = JOptionPane.showConfirmDialog(null, cajero.toString()+"\n\n"
        ...
        if(sel==0){
            ...
            if (sel2 == 0){
                do{
                    try{
                        cajero.setClave(JOptionPane.showInputDialog(
                                   null, "Defina la clave"));
                       if(cajero.getClave().length()<6){
            ...
            if (sel2 == 0){
                ...
                do{
                    try{
                        cajero.setNombre(JOptionPane.showInputDialog(
                            null, "Nombre cliente"));
                        if(cajero.getNombre().length()<4){
            ...
            sel = JOptionPane.showConfirmDialog(null, cajero.toString()+"\n\n"
